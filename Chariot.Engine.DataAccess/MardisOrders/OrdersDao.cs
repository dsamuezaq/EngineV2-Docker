                    ...
                    try
                    {
                        ...
                        foreach (var itemorden in orden.pedidosItems)
                        {
                            ...
                            Post.Add(new PedidosAPI
                            {
                                ...
                                p_PRECIO =(decimal) itemorden.importeUnitario,
                                //(decimal)Context.ProductOrders.Where(x => x.IdArticulo == itemorden.idArticulo && x.StatusRegister == "A" && x.Idaccount == orden.Idaccount).FirstOrDefault().Precio1,
