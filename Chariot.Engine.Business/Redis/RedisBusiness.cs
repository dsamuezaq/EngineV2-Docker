   ...
   public class RedisBusiness : ABusiness
    {
        ...
        public ReplyViewModel DataBankBGVue()
        {
        ...
        /// <param name="_data"></param>
        /// <returns>20200922</returns>
        public ReplyViewModel DataBankBONOBGVue()
        {
            ReplyViewModel reply = new ReplyViewModel();
            try
            {
                List<BancoBgViewModelReply> _model = new List<BancoBgViewModelReply>();
                reply.messege = "success";
                _model = _RedisCache.Get<List<BancoBgViewModelReply>>("_redisBancosBonoMies");
                reply.status = "Ok";
        ...
        public ReplyViewModel DataSurti()
        {
            ReplyViewModel reply = new ReplyViewModel();
            try
            {
                List<BancoBgViewModelReply> _model = new List<BancoBgViewModelReply>();
                reply.messege = "success";
                _model = _RedisCache.Get<List<BancoBgViewModelReply>>("_redisSurti");
                reply.status = "Ok";
